...
export default function ProductManagement() {
  ...
  const teamListAvailable = teamList.map((team) => team);
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { staffLead, staff } = row;
                      return (
                        <TableRow
                          style={{ cursor: 'pointer' }}
                          key={staffLead.accountId}
                          hover
                          tabIndex={-1}
                          role="checkbox"
                        ...
                        >
                          ...
                          >
                            <Stack direction="row" alignItems="center" spacing={2}>
                              <Typography variant="subtitle2">{staffLead.accountId}</Typography>
                            </Stack>
                          </TableCell>
                          ...
                          <TableCell align="right">
                            <AdminUserMoreMenu
                              onBlock={() => handleRemoveGroup(staffLead.accountId)}
                              onUnblock={() => {}}
                              textFirstItem="Xoá nhóm"
                              // textFirstItemAfter="Kích hoạt"
                              status={true}
                              id={staffLead.accountId}
